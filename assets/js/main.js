$(function() {
    ...
    $(window).on('scroll', function(event) { var scroll = $(window).scrollTop(); if (scroll < 10) { $(".navbar-area").removeClass("sticky");
            $(".navbar-4 .navbar-brand img").attr("src", "assets/images/logo-4.png"); } else { $(".navbar-area").addClass("sticky");
    ...
    $('.testimonial-content').slick({ slidesToShow: 1, slidesToScroll: 1, arrows: true, prevArrow: '<span class="prev"><i class="lni-arrow-left"></i></span>', nextArrow: '<span class="next"><i class="lni-arrow-right"></i></span>', asNavFor: '.testimonial-author-slider', dots: false, focusOnSelect: true });
